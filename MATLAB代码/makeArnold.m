    ...
    elseif M<N
        ...
        for q_1=1:count
            ...
            elseif q_1>1 && q_1<count
                n_1=int32(M*(q_1-1)+1-floor(M/2));
                n_2=int32(M*(q_1-1)+M-floor(M/2));
            else
                n_1=N-M+1;
                n_2=N;
            end
